...
const Header = () => {
    ...
    //simple function to toggle side bar
    const toggleMobileMenu = () => {
        //get element for toogle menu
    ...
    return (
        ...
        after:absolute after:w-0 after:h-0.5 after:bg-purple-400 after:left-0 
        ...
        after:bottom-0 after:transition-all hover:after:w-full text-nowrap'>
            ...
            {/* Mobile dev sidebar only mobile */}
        ...
        after:bottom-0 after:transition-all hover:after:w-full text-nowrap'>
                ...
                <div className="flex flex-col gap-3 w-full mt-4">
                    ...
                    <button className="bg-gray-400 py-2 rounded">
                        NFT Store
